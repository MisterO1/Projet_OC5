...
export default function SlideShow({listPictures}){
    ...
    return(
        <div className='pictures-container'>
            <img className='picture-img active' src={ listPictures[indexPictureToShow] } alt='housing' />
            { total === 1 ?
                null
                :
                <div className='picture-overlay'>
                    ...
                    <button className='btn btn-next' onClick={()=> nextPicture()} >
                        <svg className='arrow arrowForward' viewBox="0 0 48 80" fill="none" xmlns="http://www.w3.org/2000/svg">
